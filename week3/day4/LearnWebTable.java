...
public class LearnWebTable {
	...
	public static void main(String[] args) {
		...
		List<WebElement> entireCol1Data = driver.findElements(By.xpath("//span[text()='Customer Analytics Table']/following::table[2]/tbody/tr/td[1]"));
		...
		for (int k = 0; k < entireCol1Data.size(); k++) {
			String textCol = entireCol1Data.get(k).getText();
			System.out.println("Entire Col:"+textCol);
			}
		...
		//WebElement col = table.findElement(By.xpath("//span[text()='Customer Analytics Table']/following::table[2]/tbody/tr/td["+i+"]"));
